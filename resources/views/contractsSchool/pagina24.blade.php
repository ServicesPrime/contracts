...
<!-- ====== PÁGINA 24 - EXHIBIT C: CONFIDENTIALITY AGREEMENT ====== -->
<div class="page">
@php
...
@endphp
    ...
    <div class="content content-with-padding" style="position: relative; z-index: 2;">
        ...
        <p style="line-height: 1.4; margin-bottom: 20px;">As a condition of my assignment by PRIME to CLIENT, I at this moment agree as follows:</p>

        <ul style="line-height: 1.4; margin-bottom: 30px;">
