...
@endphp
    ...
    <div class="content content-with-padding" style="position: relative; z-index: 2;">
        ...
        <div class="sub-list">
            ...
            <p class="sub-item">h.  Provide access to the facility and any necessary site-specific information or resources required for the proper execution of the services described in the Awty International School handbook.</p>
