<div class="page">
    ...
    <div  class="content-padding" style="position: relative; z-index: 2;">
        ...
        <br>
        <div class="subtitulo">Late Payment Penalty</div>
        <br>
        <div class="texto-normal">
        ...
        <br>
        <div class="subtitulo">No Staff Hire - Always; Fee</div>
        <br>
        <div class="texto-normal">
        ...
        <br>
        <div class="subtitulo">Nature of Relationship</div>
        <br>
        <div class="texto-normal">
        ...
        <br>
        <div class="subtitulo">Headings</div>
        <br>
        <div class="texto-normal">
        ...
        <br>
        <div class="subtitulo">Arbitration</div>
        <br>
        <div class="texto-normal">
