...
<div class="page">
    @php
    // Ruta para la marca de agua
    $watermarkPath = 'C:\laragon\www\contracts\storage\app\public\prime.png';
    $watermark64 = file_exists($watermarkPath) ? 'data:image/png;base64,' . base64_encode(file_get_contents($watermarkPath)) : '';
    @endphp
