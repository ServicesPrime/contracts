{{-- C:\laragon\www\contracts\resources\views\contracts\pagina17.blade.php --}}

<!-- ====== PÁGINA 17 - TECHNICAL ANNEX ====== -->
<div class="page">
@php
...
@endphp
    ...
    <div class="content content-with-padding" style="position: relative; z-index: 2;">
        ...
        <p style="line-height: 1.4; margin-bottom: 25px;">
            This annex aims to outline, as a reference, the areas, activities, and quality criteria recommended for 
            carrying out the Initial Deep Cleaning Service, with the objective of reaching an optimal level of 
            cleanliness that will serve as the basis for the regular service.
        </p>

        <h3>1. Areas included:</h3>
        <p style="line-height: 1.4; margin-bottom: 20px;">
            Classrooms, offices, restrooms, hallways, sports areas, cafeteria, and other spaces agreed upon by the parties.
        </p>

        <h3>2. Activities included:</h3>
        <ul style="line-height: 1.4; margin-bottom: 20px;">
        ...
        <h3>3. Completion standard:</h3>
        <p style="line-height: 1.4;">
            All included areas must be free from visible dirt, unpleasant odors, and with surfaces clean to the touch, 
            as verified by both parties.
        </p>
