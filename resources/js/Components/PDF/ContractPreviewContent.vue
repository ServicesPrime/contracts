  ...
  <div class="pdf-preview bg-white border border-gray-200 shadow-sm p-8" style="max-width: 210mm; margin: 0 auto;">
    ...
    <div class="grid grid-cols-3 gap-6 mb-6">
      ...
      <div>
        ...
        <div class="value">
          ...
          <div v-if="!contract?.client?.address && contract?.client" class="italic text-gray-500">
            No address available
          </div>
          <div v-if="!contract?.client" class="italic text-gray-500">
            No client selected
          </div>
        </div>
      </div>
      ...
      <div>
        ...
        <div class="value">
          <div v-if="contract?.client" class="font-medium">{{ contract.client.name }}</div>
          <div v-if="contract?.client">{{ contract.client.email || 'N/A' }}</div>
          <div v-if="contract?.client">{{ contract.client.phone || 'N/A' }}</div>
      ...
      <div>
        ...
        <span class="text-red-600 font-bold text-lg">{{ contract?.contract_number || 'Not specified' }}</span>
      </div>
    </div>
    ...
    <div v-else class="mb-8">
      <table class="contract-table">
        ...
        <tbody>
          <tr>
            <td colspan="6" class="text-center italic text-gray-500 py-4">
...
// Calculate contract total for paid services only
...
// Get service specifications for paid services
...
// Get terms and conditions services
...
// Get paid services only (not terms)
