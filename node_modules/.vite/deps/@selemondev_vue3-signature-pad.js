...
// node_modules/@selemondev/vue3-signature-pad/dist/index.js
...
var _sfc_main = defineComponent({
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    function resizeCanvas(c) {
      ...
      const ratio = Math.max(window.devicePixelRatio || 1, 1);
      const reg = /px/;
      c.width = props.width && reg.test(props == null ? void 0 : props.width) ? Number.parseInt(props == null ? void 0 : props.width.replace(/px/g, "")) * ratio : c.offsetWidth * ratio;
      c.height = props.height && reg.test(props == null ? void 0 : props.height) ? Number.parseInt(props == null ? void 0 : props.height.replace(/px/g, "")) * ratio : c.offsetHeight * ratio;
      (_a = c.getContext("2d")) == null ? void 0 : _a.scale(ratio, ratio);
      clearCanvas();
...
signature_pad/dist/signature_pad.js:
   ...
   *)
*/
//# sourceMappingURL=@selemondev_vue3-signature-pad.js.map
